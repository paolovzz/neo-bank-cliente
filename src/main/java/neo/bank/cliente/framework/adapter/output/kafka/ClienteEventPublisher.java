package neo.bank.cliente.framework.adapter.output.kafka;
...
import neo.bank.cliente.framework.adapter.output.kafka.integration_events.converters.IntegrationEventConverterFactory;
